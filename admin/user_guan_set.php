...
$result = $db1->query("select * from web_agent where id=" . $_GET['id'] . " and lx=3 order by id");
...
if ($_GET['act'] == "edit") {
	...
	echo "<script>alert('设定成功!'); window.location.href = 'main.php?action=user_guan_set&uid=" . $uid . "&id=".$userid."';</script>";
	exit;
} 
?>
...
<body style="min-width: 1200px;width: 100%">
     <div id="tit" class="tit" >
      ...
      <div class="tit_center floatleft font_bold"><span class="font_g">股东详细设定&nbsp;</span><span class="font_b">添加直属会员</span></div>
      <div class="tit_right floatleft"><img src="/images/tit_03.png" width="5" height="31" alt=""></div>
      <div class="biaoti_right floatright">
	 <table border="0" align="right" cellpadding="0" cellspacing="0">
		<tr>
			<td height="28" style="color:#fff;">&nbsp;股东详细设定&nbsp;账号:
				<?=$username?> -- 名称:
	...
	<form action="main.php?action=user_guan_set&uid=<?=$uid?>&act=edit&id=<?=$userid?>" method="post" name="form1"
...
?>
			<tr bgcolor="#edf2f7">
				...
				<td align="center" bgcolor="#FFFFFF"><input name="yg[]" class="za_text" id="yg[]"
						onkeyup="value=value.replace(/[^\d\.\/]/ig,'')"
						onBlur="return CountGold(this,'A','SP','mrds[<?=$t?>][1]','<?=$t?>');" value='<?=$image['yg']?>' size="10" /></td>
				<td align="center" bgcolor="#FFFFFF"><input name="ygb[]" class="za_text" id="ygb[]"
						onkeyup="value=value.replace(/[^\d\.\/]/ig,'')"
						onBlur="return CountGold(this,'B','SP','mrds[<?=$t?>][2]','<?=$t?>');" value='<?=$image['ygb']?>' size="10" /></td>
				<td align="center" bgcolor="#FFFFFF"><input name="ygc[]" class="za_text" id="ygc[]"
						onkeyup="value=value.replace(/[^\d\.\/]/ig,'')"
						onBlur="return CountGold(this,'C','SP','mrds[<?=$t?>][3]','<?=$t?>');" value='<?=$image['ygc']?>' size="10" /></td>
				<td align="center" bgcolor="#FFFFFF"><input name="ygd[]" class="za_text" id="ygd[]"
						onkeyup="value=value.replace(/[^\d\.\/]/ig,'')"
