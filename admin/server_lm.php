...
{
    $result5 = $db1->query( "SELECT sum(if(lx=5 and dagu='外调',sum_m,0)) as sum_wai,sum(".$tb_zd.") as sum_sum,sum(sz) as zs,sum(".$tb_zd."*rate) as win FROM ".$tb_name." WHERE qx=0 ".$vvv." and class1='连码' and ds_lb='".$rs['ds_lb']."'" );
    ...
    $list_table[$ii]['zs'] = (integer)$row['zs']; //注数
