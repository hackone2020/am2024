...
<script language="JavaScript">
    ...
    var lj_time = 1;
    var dq_time = "";
    date("F d,Y H:i:s", strtotime($utime));
    var fp_time = "";
    date("F d,Y H:i:s", strtotime($Current_KitheTable['kizm1']));
    var url = "main.php?action=list_yt&uid=";
    $uid;
    "&kithe=";
    $kithe;
    "&abcd=";
...
<body style="min-width: 1200px;width: 100%">
                            ...
                            <tr class="t_list_caption">
                                <td>
                                    ...
                                    <span style="float: right;">
                                        ...
                                        </select><input name="action" type="hidden" id="action" value="list_yt" />
    ...
    <DIV id="rs_window" style="DISPLAY: none; POSITION: absolute">
        <form action="main.php?action=list_yt&uid=<?= $uid ?>&act=save&kithe=<?= $kithe ?>" method="post" name="form1">
            <? include "zf.php"; ?>
        </form>
    </div>

    <SCRIPT language="javascript">
        makeRequest('main.php?action=server_yt&uid=<?= $uid ?> kithe=<?= $kithe ?> abcd=<?= $abcd ?>& zc=<?= $zc ?>& page=<?= $page ?> ')
    </script>
    <? if ($Current_KitheTable[29] != 0 && $Current_KitheTable[15] != 0 && $kithe == $Current_Kithe_Num) { ?>
