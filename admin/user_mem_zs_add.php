...
if ($_GET['act'] == "add") {
    ...
    echo "<script>alert('添加成功!');window.location.href='main.php?action=user_mem_zs_list&uid=" . $uid . "&agent=" . $dai . "';</script>";
    exit;
}?>
...
<script>
            function SubChk() {
                if ($("agent").value == '') { $("agent").focus(); alert("请选择上级!!"); return false; }
                ...
                if (isNaN($("xy").value)) { alert('单注最低投注额只能输入数字'); $("xy").focus(); return false; t }
...
<body style="min-width: 1200px;width: 100%">
 <div id="tit" class="tit" >
      ...
      <div class="tit_center floatleft font_bold"><span class="font_g">直属会员管理－</span><span class="font_b">添加直属会员员</span></div>
      <div class="tit_right floatleft"><img src="/images/tit_03.png" width="5" height="31" alt=""></div>
      <div class="biaoti_right floatright">   
            <? if ($dai == "") {?>
            <td width="53" class="m_tline">直属类型-</td>
            ...
            <td width="54" class="m_tline">上级账号-</td>
    ...
    while ($image = $result->fetch_array()) {?>
            ...
            <td width="215" class="m_tline"><a href="main.php?action=user_mem_zs_list&uid=<?=$uid?>">回上一页</a></td>
            <?}?>
    ...
    <br>
     <table width="800" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        <tr>
            <td height="20" colspan="2" class="t_list_caption">上级(<?=$dai?>)资料简述
            </td>
        </tr>
...
<?}?>
                <form name="form1" onSubmit="return SubChk()" method="post"
                   ...
                   <table width="800" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
                        ...
                        <tr>
                            <td width="16%" height="30" align="right" bgcolor="#FFFFFF" class="t_edit_caption">上级账号:</td>
                            <td height="30" bgcolor="#FFFFFF" class="t_edit_td">
                                ...
                                <?=$dai?>
                                &nbsp;&nbsp;&nbsp;&nbsp;直属类型:<?=$zslabel?>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                    href="main.php?action=user_mem_zs_add&uid=<?=$uid?>">重新选择上级</a>
                                <?}?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="30" bgcolor="#FFFFFF" class="t_edit_td">
                                ...
                                <input name="username" type="text" class="inp1" id="username" />&nbsp;<input
                                    type="button" onClick="check_user();" value="检查账号"
                                    class="za_button" />&nbsp;帐号必须至少1个字元长，最多12个字元长，并只能有数字(0-9)，及英文小写字母
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td height="30" bgcolor="#FFFFFF" class="t_edit_td"><input name="pass" type="password"
                                    class="inp1" id="pass" />&nbsp;密码必须至少6个字元长，最多12个字元长，并只能有数字(0-9)，及英文大小写字母 </td>
                        </tr>
                        <tr>
