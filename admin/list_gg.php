...
<script language="JavaScript">
    ...
    var url = "main.php?action=list_gg&uid=<?= $uid ?>&kithe =<?= $kithe ?>&abcd=<?= $abcd ?>&zc="
    <?= $zc ?>
</script>
...
<body style="min-width: 1200px;width: 100%">
                                ...
                                <tr> <!--外层td start-->
                                    <td colspan="14" align="center" class="t_list_caption">
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <td height="28" width="180" align="left" class="font_b">
                                                        <?= $ids ?>&nbsp;<Select id="kithe" name="kithe" onChange="document.myFORM.submit();" class="za_select">
    ...
    <DIV id="rs_window" style="DISPLAY: none; POSITION: absolute">
        <form action="main.php?action=list_gg&uid=<?= $uid ?>&act=save&kithe=<?= $kithe ?>" method="post" name="form1">
            <? include "zf.php"; ?>
        </form>
    </div>

    <SCRIPT language="javascript">
        makeRequest('main.php?action=server_gg&uid=<?= $uid ?>&kithe=<?= $kithe ?>&abcd=<?= $abcd ?>&zc=<?= $zc ?>&page=<?= $page ?>')
    </script>
    <? if ($Current_KitheTable[29] != 0 && $Current_KitheTable[15] != 0 && $kithe == $Current_Kithe_Num) { ?>
