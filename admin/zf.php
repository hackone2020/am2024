    ...
    <tr>
        <td bgcolor="#FFFFFF">
            ...
            <table width="200" border="0" cellspacing="0" cellpadding="0" bgcolor="0163A2" class="m_tab_fix">
                <tr bgcolor="0163A2">
                    <td>
                        <font color="#FFFFFF">补货</font>
                    </td>
                    <td align="right" valign="top">
                        <a style="cursor:pointer;" onClick="close_win();"><img src="images/edit_dot.gif" width="16" height="14"></a>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table width="200" border="0" cellpadding="0" cellspacing="0" bgcolor="0163A2" class="m_tab_fix">
                    ...
                    <td>
                        <select name="classname" id="classname">
                            ...
                            while ($image = $result->fetch_array()) {
                                echo "<OPTION value=外调" . $image['classname'];
                                echo ">外调" . $image['classname'] . "</OPTION>";
                            } ?>
                ...
                <tr bgcolor="#A4C0CE">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="40%">
                                    <input name="rate" type="text" id="rate" value="0" size="6" class="za_text" />
                                </td>
                ...
                <tr bgcolor="#A4C0CE">
                    <td height="20" colspan="2" align="center">
                        ...
                        <input type="button" name="Submit2" onclick="javascript:close_win()" class="buttonnor" value="取消" />
