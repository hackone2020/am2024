...
$result = $db1->query("select * from web_agent where id=" . $_GET['id'] . " and lx=1 order by id LIMIT 1");
...
if ($_GET['act'] == "edit") {
    ...
    echo "<script>alert('修改成功!'); window.location.href = 'main.php?action=user_dai_edit&uid=" . $uid . "&id=" . $userid . "';</script>";
    exit;
}?>
...
<div id="tit" class="tit" >
    ...
    <table width="800"border="0" align="center" cellpadding="0" cellspacing="1" class="t_list bet">
        ...
        <tr>
            ...
            <td class="t_edit_td">可用占成数:<?=$zongmaxzc?>%&nbsp;&nbsp;&nbsp;总信用额:<?=$zongmaxcs?>&nbsp;&nbsp;&nbsp;已用信用额:<?=$mumuzong?>
                &nbsp;&nbsp;&nbsp;剩余信用额:<?=$zongmaxcs-$mumuzong?>
            </td>
        </tr>
        <tr>
    ...
    <?}?>
    <form action="main.php?action=user_dai_edit&uid=<?=$uid?>&act=edit&id=<?=$_GET['id']?>" method="post" name="form1" id="form1" onSubmit="return SubChk()">
        ...
        <table width="800"border="0" align="center" cellpadding="0" cellspacing="1" class="t_list bet">
            ...
            <tr>
                ...
                <td height="30" colspan="3" bgcolor="#FFFFFF" class="t_edit_td"><input name="pass" type="password"
                        class="inp1" id="pass" />(密码不修改请留空)&nbsp;&nbsp;密码必须至少6个字元长，最多12个字元长，并只能有数字(0-9)，及英文大小写字母
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3" nowrap="nowrap" bgcolor="#FFFFFF" class="t_edit_td"><input name="xm" type="text"
