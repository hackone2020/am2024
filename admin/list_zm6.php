...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="t_list" >
        <form action="main.php" method="get" name="myFORM" id="myFORM">
            <tr>
                 <!--外层td start-->
                    ...
                    <td colspan="12" align="center" class="t_list_caption">
                             <!--top table 二层-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="kithe" name="kithe" onChange="document.myFORM.submit();" class="za_select">
                                            ...
                                            <option value='<?=$image['nn']?>' >第<?=$image['nn']?>期
                                            </OPTION>
                                            <?}?>
                                        </select>
                                    </td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="3">
        <tr>
            <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码1</b></font>
            </td>
                 <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码2</b></font>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码3</b></font>
            </td>
            <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码4</b></font>
            </td>
        </tr>
        <tr>
            <td valign="top">
        ...
        <tr>
            <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码5</b></font>
            </td>
           <td height="20" align="center" class="t_list_tr_3">
                <font color="green"><b>正码6</b></font>
            </td>
        </tr>
        <tr>
            <td valign="top">
                <table id="tb5" border="0" cellspacing="1" cellpadding="0" bgcolor="C2C2A6" class="m_tab" width="100%">
                    <tr class="m_title_ft_future">
                        <td height="20" align="center" class="t_list_tr_3">号码</td>
                        <td align="center" class="t_list_tr_3">赔率</td>
                        <td align="center" class="t_list_tr_3">注单数</td>
            ...
            <td valign="top">
                <table id="tb6" border="0" cellspacing="1" cellpadding="0" bgcolor="C2C2A6" class="m_tab" width="100%">
                    <tr class="m_title_ft_future">
                        <td height="20" align="center" class="t_list_tr_3">号码</td>
                        <td align="center" class="t_list_tr_3">赔率</td>
                        <td align="center" class="t_list_tr_3">注单数</td>
        ...
        <tr>
            <td colspan="2" align="center" valign="top">
                <table id="tb7" border="0" cellspacing="1" cellpadding="0" bgcolor="C2C2A6" class="m_tab" width="450">
                    <tr class="m_title_ft_future">
    ...
    <DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
        <form action="main.php?action=list_zm6&uid=<?=$uid?>&act=save&kithe=<?=$kithe?>" method="post" name="form1">
            <? include "zf.php";?>
        </form>
    </div>
    <SCRIPT language=javascript>makeRequest('main.php?action=server_zm6&uid=<?=$uid?>&kithe=<?=$kithe?>&abcd=<?=$abcd?>&zc=<?=$zc ?>')</script>
    <? if ($Current_KitheTable[29] != 0 && $Current_KitheTable[15] != 0 && $kithe == $Current_Kithe_Num) {?>
