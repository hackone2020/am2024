...
<div id="tit" class="tit" >
     ...
     <table border="0" align="right" cellpadding="0" cellspacing="0">
        <tbody>
         <tr>
            ...
            全部
            <?}?>
            &nbsp;&nbsp;(以下所有结果均包含退水)&nbsp;&nbsp;股东:<?=$user?>--<a href="javascript:history.go(-1);"><font color="#ffffff">回上一页</font></a>
        </td>
        </tr>
    </tbody>
    </table>
    ...
    <? $result = $db1->query("SELECT zong,sum(sz) as zs,sum(sum_m) as sum_m,sum(user_sf) usersf,sum(user_sq) user_ds,sum(dai_sq) dai_ds,sum(zong_sq) zong_ds,sum(guan_sq) guan_ds,sum(guanzc) as guanzc,sum(guan_sf) as guansf,sum(daguzc) as daguzc,sum(dagu_sf) as dagusf,sum(gszc) as gszc,sum(gs_sf) as gssf FROM " . $tb_name . "  WHERE guan='" . $user . "' and dai!='" . $user . "' and username!='" . $user . "' " . $vvv . " group by zong order by zong DESC");
$ii = 0;
if ($result->num_rows != 0) {?>
     <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        <tr>
            <td height="18" colspan="11" align="center" nowrap="nowrap" class="t_list_caption">下级总代理注单</td>
        </tr>
        <tr>
            ...
            <td align="center" class="t_list_tr_3">股东占成金额</td>
            <td align="center" class="t_list_tr_3">股东赚水</td>
            <td align="center" bgcolor="#CC0000" class="t_list_tr_3">股东结果</td>
        ...
        <tr bgcolor="#ffffff" onmouseover="javascript:this.bgColor='#FFFFA2'" onmouseout="javascript:this.bgColor='#ffffff'">
            ...
            <td align="center" nowrap="nowrap"><a href='main.php?action=report_m4&uid=<?=$uid?>&kithe=<?=$kithe?>&user=<?=$rs['zong']?>&date_start=<?=$date_start?>&date_end=<?=$date_end?>&gtype=<?=$gtype?>'><?=round($sum_m, 2)?></a> </td>
            <td height="28" align="center" nowrap="nowrap">
                <?=round($usersf, 2)?>
            </td>
            <td align="center" nowrap="nowrap">
        ...
        <tr class="t_list_tr_2">
            ...
            <td align="center" nowrap="nowrap"><?=round($z_guands1, 2)?></td>
            <td align="center" nowrap="nowrap"><?=round($z_guansf1, 2)?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round($z_guansf1 + $z_dagusf1 + $z_gssf1, 2))?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round(0 - $z_gssf1 - $z_dagusf1, 2))?></td>
        </tr>
    </table><br>
    <?
    }
    $result = $db1->query("SELECT username,sum(sz) as zs,sum(sum_m) as sum_m,sum(user_sf) usersf,sum(user_sq)
    user_ds,sum(dai_sq) dai_ds,sum(dagu_sq) dagu_ds,sum(guanzc) as guanzc,sum(guan_sf) as guansf,sum(daguzc) as
    daguzc,sum(dagu_sf) as dagusf,sum(gszc) as gszc,sum(gs_sf) as gssf FROM " . $tb_name . " WHERE guan='" . $user . "'
    and dai='" . $user . "' and username!='" . $user . "' " . $vvv . " group by username order by username DESC");
    $ii = 0;
    if ($result->num_rows != 0) {
 ?>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        ...
        <tr>
            <td height="18" align="center" nowrap="nowrap" class="t_list_caption">序号</td>
            <td align="center" class="t_list_caption">会员</td>
            <td align="center" class="t_list_caption">组数</td>
            <td align="center" class="t_list_caption">下注金额</td>
            <td align="center" class="t_list_caption">结果</td>
            <td align="center" class="t_list_caption">退水</td>
            <td align="center" class="t_list_caption">股东占成金额</td>
            <td align="center" class="t_list_caption">股东赚水</td>
            <td align="center" bgcolor="#CC0000" class="t_list_caption">股东结果</td>
            <td align="center" class="t_list_caption">与会员交收</td>
            <td align="center" class="t_list_caption">与大股东交收</td>
        </tr>
        <?
        while ($rs = $result->fetch_array()) {
        $sum_m = $usersf = $guansf = $dagusf = $gssf = $userds = $guands = $daguds = $guanzc = $daguzc = $gszc = 0;
 ...
 <tr class="m_rig" onMouseOver="setPointer(this, 0, 'over', '#FFFFFF', '#FFCC66', '#FFCC99');"
        ...
        <tr class="m_rig_re">
            ...
            <td align="center" nowrap="nowrap"><?=round($z_guands2, 2)?></td>
            <td align="center" nowrap="nowrap"><?=round($z_guansf2, 2)?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round($z_guansf2 + $z_dagusf2 + $z_gssf2, 2))?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round(0 - $z_gssf2 - $z_dagusf2, 2))?></td>
        </tr>
    </table><br>
    <?
    }
    ...
    " . $tb_name . " WHERE lx=3 and username='" . $user . "' " . $vvv . " group by username order by username DESC");
    $ii = 0;
    if ($result->num_rows != 0) {
?><table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        <tr>
            <td height="18" colspan="7" nowrap="nowrap" class="t_list_caption">股东补货走飞结果</td>
        </tr>
        <tr>
            <td height="18" align="center" nowrap="nowrap" class="t_list_caption">序号</td>
            <td align="center" class="t_list_caption">股东</td>
            <td align="center" class="t_list_caption">组数</td>
...
?><tr class="m_rig" onMouseOver="setPointer(this, 0, 'over', '#FFFFFF', '#FFCC66', '#FFCC99');"
            ...
            <td align="center" nowrap="nowrap"><?=$rs['zs']?></td>
            <td align="center" nowrap="nowrap"><a href='main.php?action=report_m6&uid=<?=$uid?>&kithe=<?=$kithe?>&user=<?=$rs['username']?>&date_start=<?=$date_start?>&date_end=<?=$date_end?>&gtype=<?=$gtype?>&lx=3' ><?=round($sum_m, 2)?></a></td>    
            <td height=" 28" align="center" nowrap="nowrap"><?=round($usersf, 2)?></td>
            <td align="center" nowrap="nowrap"><?=round($userds, 2)?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round(0 - $gssf - $dagusf, 2))?></td>
        </tr>
        ...
        <tr>
            ...
            <td align="center" nowrap="nowrap"><?=get_sf(round(0 - $z_gssf3 - $z_dagusf3, 2))?></td>
        </tr>
    </table><br>
    <?
    }
  ...
  ?><table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        <tr>
            <td height="18" colspan="9" nowrap="nowrap" align="center" class="t_list_caption">总计</td>
        </tr>
        <tr bgcolor="#ffffff" onmouseover="javascript:this.bgColor='#FFFFA2'" onmouseout="javascript:this.bgColor='#ffffff'">
            ...
            <td align="center">股东占成</td>
            <td align="center">股东赚水</td>
            <td align="center" bgcolor="#CC0000">股东结果</td>
            <td align="center">与下级交收</td>
        ...
        <tr class="t_list_tr_2">
            ...
            <td align="center" nowrap="nowrap"><?=round($z_guands1 + $z_guands2, 2)?></td>
            <td align="center" nowrap="nowrap"><?=round($z_guansf1 + $z_guansf2 + $z_guansf3, 2)?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round($z_guansf1 + $z_dagusf1 + $z_gssf1, 2) + round($z_guansf2 + $z_dagusf2 + $z_gssf2,
                2))?></td>
            <td align="center" nowrap="nowrap"><?=get_sf(round(0 - $z_gssf1 - $z_dagusf1, 2) + round(0 - $z_gssf2 - $z_dagusf2, 2) + round(0 -$z_gssf3 - $z_dagusf3, 2))?></td>
        </tr>
    </table>
    <?
    } else {
