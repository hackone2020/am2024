    ...
    if (http_request.readyState == 4) {
        ...
        if (http_request.status == 0 || http_request.status == 200) {
		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				{
					if (i < 49){
						var strtmp = "look.html?action=list_look&uid="+uid+"&kithe="+kithe+"&class1="+ids+"&class3="+arrTmp[1];
					}else{
					    var strtmp = "look.html?action=list_look&uid="+uid+"&kithe="+kithe+"&class1=总分&class3="+arrTmp[1];
					}
				...
				if ( i!=(arrResult.length-2) && arrTmp[7] != "" && arrTmp[7] != 0 )
				{
					if (i < 49){
					    ...
					    var strtmp = "look.html?action=list_look&uid="+uid+"&kithe="+kithe+"&lx=5&class1=总分&class3="+arrTmp[1];
					}
