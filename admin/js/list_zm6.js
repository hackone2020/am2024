    ...
    if (http_request.readyState == 4) {
        ...
        if (http_request.status == 0 || http_request.status == 200) {
		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&kithe="+kithe+"&class1="+ids+"&class2="+arrTmp[8]+"&class3="+arrTmp[1];
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&kithe="+kithe+"&lx=5&class1="+ids+"&class2="+arrTmp[8]+"&class3="+arrTmp[1];
