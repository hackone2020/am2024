        ...
        <tbody>
         <tr>
           <td height="28" style="color:#fff;">
            ...
            &nbsp;&nbsp;(以下所有结果均包含退水) &nbsp;&nbsp;大股东:
            <?=$user?>
            --<a href="javascript:history.go( -1 );"><font color="#ffffff">回上一页</font></a>
        </td>
        </tr>
      </tbody>
    </table>
...
if ($result->num_rows != 0) {?>
       <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        ...
        <tr>
            ...
            <td align="center" class="t_list_tr_3" class="t_list_tr_3">组数</td>
   ...
   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
        ...
        <tr class="t_list_tr_3">
            ...
            <td align="center">大股东占成金额</td>
            <td align="center">大股东赚水</td>
            <td align="center" bgcolor="#CC0000">大股东结果</td>
            <td align="center">与会员交收</td>
            <td align="center">与公司交收</td>
        </tr>
        <?
        while ($rs = $result->fetch_array()) {
        $sum_m = $usersf = $dagusf = $gssf = $userds = $daguds = $daguzc = $gszc = 0;
...
?><table border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" class="m_tab" width="960">
        <tr>
            <td height="18" colspan="7" nowrap="nowrap" lass="t_list_caption">大股东补货走飞结果</td>
        </tr>
        <tr class="t_list_tr_3">
            <td height="18" align="center" nowrap="nowrap">序号</td>
