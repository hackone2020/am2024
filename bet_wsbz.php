...
if ($user_ds_temp != "") {
    $ws_xx = $user_ds_temp['WS']['xx'];
    $ws_xxx = $user_ds_temp['WS']['xxx'];
    $ws_blc = $config_ds_temp['WS'][$blc_lx];
}
?>
