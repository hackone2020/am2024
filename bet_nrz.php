...
switch ($rtype) {
	case "1":
		$XF = 15;
		$urlurl = "main.php?action=bet_1rz&uid=" . $uid . "&lx=1";
		$class2 = "一粒任中";
		$class1_temp = "粒任中";
		$class2_temp = "一粒任中";
		$bl_dslb = "1LRZ";
	...
	case "2":
		$XF = 15;
		$urlurl = "main.php?action=bet_1rz&uid=" . $uid . "&lx=2";
		$class2 = "二粒任中";
		$class1_temp = "粒任中";
		$class2_temp = "二粒任中";
		$bl_dslb = "2LRZ";
	...
	case "3":
		$XF = 15;
		$urlurl = "main.php?action=bet_1rz&uid=" . $uid . "&lx=3";
		$class2 = "三粒任中";
		$class1_temp = "粒任中";
		$class2_temp = "三粒任中";
		$bl_dslb = "3LRZ";
	...
	case "4":
		$XF = 15;
		$urlurl = "main.php?action=bet_1rz&uid=" . $uid . "&lx=4";
		$class2 = "四粒任中";
		$class1_temp = "粒任中";
		$class2_temp = "四粒任中";
		$bl_dslb = "4LRZ";
	...
	case "5":
		$XF = 15;
		$urlurl = "main.php?action=bet_1rz&uid=" . $uid . "&lx=5";
		$class2 = "五粒任中";
		$class1_temp = "粒任中";
		$class2_temp = "五粒任中";
		$bl_dslb = "5LRZ";
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list" id="dengtai">
	...
	<form action="main.php?action=bet_save_nrz&uid=<?= $uid ?>&class2=<?= $class2 ?>" method="post" name="form1" id="form1" onSubmit="return LMSubChk()">
					<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="t_list">
						<tbody bgcolor="#ffffff">
							...
							<tr>
								<td id="leixing" colspan="2" class="tdxianxi1" align="center"><?= $bl_class1 . "-" . $bl_class2 ?></td>
							</tr>
							<tr>
								<td id="peilv" colspan="2" class="tdxianxi1" align="center">赔率：<font color='red'><?= $text1 ?></font><input name="rate_1" type="hidden" value="<?= $rate0 ?>" /></td>
							</tr>
							<tr>
								<td id="number" colspan="2" class="tdxianxi1" align="center" style="word-break: break-all;"><?= $bl_class3 ?></td>
							</tr>
							<tr>
								<td id="numbersum" colspan="2" align="center" class="tdxianxi1">共<?= $sum_count ?>组</td>
							</tr>
							<tr>
								<td id="sum" colspan="2" class="tdxianxi1" align="center">下注金额： <br> 每组<?= $sum_sum ?>/总共<?= $sum_m ?>
							...
							<tr>
								<td id="oddsmess" colspan="2" style="color: Red; display: none;white-space:nowrap;" class="tdxianxi1" align="center"></td>
							</tr>
										
							<tr>
								<td colspan="2" style="padding-top:4px; padding-bottom: 4px; border-top: 1px #808080 solid;border-bottom: 1px #808080 solid;" align="center">
			...
			<tbody bgcolor="#ffffff">
				<tr align="center">
                 <td colspan="2" align="center">
						...
						<tr>
							<td colspan="2" align="center"><?=$bl_class1?>"下注确认</td></td>
						</tr>
					</table>
				</td>
				</tr>
