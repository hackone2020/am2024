...
while ($rs = $result->fetch_assoc()) {
    $result5 = $db1->query("SELECT sum(if(username='" . $kauser . "',sum_m,0)) as sum_wai,sum(if(username='" . $kauser . "',-sum_m," . $tb_zd . ")) as sum_sum,sum(sz) as zs,sum(if(username='" . $kauser . "',-sum_m*rate," . $tb_zd . "*rate)) as win FROM " . $tb_name . " WHERE " . $select_sql . " and qx=0 " . $vvv . " and class1='多中一' and class2='" . $rs['class2'] . "'");
