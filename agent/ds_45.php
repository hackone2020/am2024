...
if ($sum_m < $zf_sum) {
    echo "<script>alert('对不起,(" . $zf_class1 . "-" . $zf_class3 . ")您" . $kithe . "期单组占成金额：" . $sum_m . ",没有达到走飞金额：" . $zf_sum . "!');window.history.go(-1);</script>";
    exit;
}
switch ($pzall) {
    case "0":
