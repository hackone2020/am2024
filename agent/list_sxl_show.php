...
echo ":";
echo $class2;
?>&nbsp;&nbsp;统计排行<table id="tb1" border="0" cellspacing="1" cellpadding="0"  bgcolor="C2C2A6" class="m_tab" width="100%">  
<tr class="m_title_tn">    
<td width="252">号码</td>    
<td width="61">注单数</td>    
<td width="112">总额</td> 
...
$last = $pagecount;
if ($num == 0) {
    echo "<tr bgcolor=\"#FFFFFF\">    <td height=\"35\" colspan=\"6\" align=\"center\">查无任何资料!</td>  </tr>";
} else {
...
<td height="28" align="center"> <?
        $strtmp = "look.html?action=list_look&uid=" . $uid . "&vip=" . $vip . "&kithe=" . $kithe . "&class2=" . $class2 . "&class3=" . $image['class3'];?> <button class="btn1" onmouseover="this.className='btn2';return true;" onMouseOut="this.className='btn1';return true;" onClick="ops('<?=$strtmp?>',400,750);"><?=round( $image['sum_sum'], 2 )?>
</button>    
</td>    
