    ...
    if (http_request.readyState == 4) {
        ...
        if (http_request.status == 0 || http_request.status == 200) {
		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&class1="+ids+"&class2="+arrTmp[8]+"&class3="+arrTmp[1];
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&lx="+lx+"&class1="+ids+"&class2="+arrTmp[8]+"&class3="+arrTmp[1];
				...
				if ( i >=33 && i <44){
				    row1 = document.getElementById("tb4").insertRow(document.getElementById("tb4").rows.length);
				}
				if ( i >=44 && i <55){
				    row1 = document.getElementById("tb5").insertRow(document.getElementById("tb5").rows.length);
				}
				if ( i >=55 && i <66){
				    row1 = document.getElementById("tb6").insertRow(document.getElementById("tb6").rows.length);
				}
				if ( i >=66 ){
				    row1 = document.getElementById("tb7").insertRow(document.getElementById("tb7").rows.length);
					row1.bgColor='#FFFFFF';
					row1.height="28px";
...
function RemoveRow()
{
	...
	iRows = document.getElementById("tb4").rows.length;
	for(var i=0;i<iRows-1;i++)
	{
		document.getElementById("tb4").deleteRow(1);
	}
	iRows = document.getElementById("tb5").rows.length;
	for(var i=0;i<iRows-1;i++)
	{
		document.getElementById("tb5").deleteRow(1);
	}
	iRows = document.getElementById("tb6").rows.length;
	for(var i=0;i<iRows-1;i++)
	{
		document.getElementById("tb6").deleteRow(1);
	}
	iRows = document.getElementById("tb7").rows.length;
	for(var i=0;i<iRows-1;i++)
	{
		document.getElementById("tb7").deleteRow(1);
	}
}