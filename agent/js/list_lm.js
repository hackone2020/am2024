...
function show_lm(c2){
	if(c2=='')	{
		...
		var str0 = 'main.php?action=list_lm_show&uid='+uid+'&vip='+vip+'&class2='+c2+'&abcd='+abcd+'&zc='+zc+'&kithe='+kithe+"&";
	    var str1 =  sendCommand("",str0,"");
		url      = 'main.php?action=list_lm_show&uid='+uid+'&vip='+vip+'&class2='+c2+'&abcd='+abcd+'&zc='+zc+'&kithe='+kithe;
		$("list_div").innerHTML = str1;
	}
}
...
function show_win_lm(class3,zs,sum_m,rate,rate2,ds,class1,class2) {
