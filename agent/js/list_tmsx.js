    ...
    if (http_request.readyState == 4) {
        ...
        if (http_request.status == 0 || http_request.status == 200) {
		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&class2="+ids+"&class3="+arrTmp[1];
				...
				{
					var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&lx="+lx+"&class2="+ids+"&class3="+arrTmp[1];
