...
function show_lm(c2){
	if(c2=='')	{
		...
		var str0 = 'main.php?action=list_sxl_show&uid='+uid+'&vip='+vip+'&class2='+c2+'&abcd='+abcd+'&zc='+zc+'&kithe='+kithe+"&";
	    var str1 =  sendCommand("",str0,"");
		url      = 'main.php?action=list_sxl_show&uid='+uid+'&vip='+vip+'&class2='+c2+'&abcd='+abcd+'&zc='+zc+'&kithe='+kithe;
		$("list_div").innerHTML = str1;
	}
}
