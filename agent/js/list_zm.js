		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				if ( i!=(arrResult.length-2) && arrTmp[4] != "" && arrTmp[4] != 0 )
				{
					if (i < 49){
					    ...
					    var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&class1=总分&class3="+arrTmp[1];
					}
				...
				if ( i!=(arrResult.length-2) && arrTmp[7] != "" && arrTmp[7] != 0 )
				{
					if (i < 49){
					    ...
					    var strtmp = "look.html?action=list_look&uid="+uid+"&vip="+vip+"&kithe="+kithe+"&lx="+lx+"&class1=总分&class3="+arrTmp[1];
					}
