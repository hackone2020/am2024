        ...
        if (http_request.status == 0 || http_request.status == 200) {
		    ...
		    for(var i=0;i<arrResult.length-1;i++)
            {
				...
				if ( i!=(arrResult.length-2) && arrTmp[8] != "" && arrTmp[8] != 0 )
				{
				    ...
				    num8 = "<center><button class=btn1 onmouseover=this.className='btn2';return true; onMouseOut=this.className='btn1';return true; onClick=ops('"+strtmp+"',400,750) >"+arrTmp[8]+"</button></center>"; //字段num8的值
				}else{
				    num8 = "<center>"+arrTmp[8]+"</center>"; //字段num8的值
				}
				if (i < 49)
				{
