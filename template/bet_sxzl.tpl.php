<table  width="800" border="0" cellpadding="0" cellspacing="0">
   ...
   <table  width="800" border="0" cellpadding="0" cellspacing="1" class="t_list">
    ...
    <tr>
        ...
        <INPUT name="rtype" type=radio onclick=go_main(url+"1"); value="1" <?if ($lx=="1" ) {?>checked<?}?>><span>一肖量</span>
        <INPUT name="rtype" type=radio onclick=go_main(url+"2"); value="2" <?if ($lx=="2" ) {?>checked<?}?>><span>二肖量</span>
        <INPUT name="rtype" type=radio onclick=go_main(url+"3"); value="3" <?if ($lx=="3" ) {?>checked <?}?>><span>三肖量</span>
		<INPUT name="rtype" type=radio onclick=go_main(url+"4"); value="4" <?if ($lx=="4" ) {?>checked <?}?>><span>四肖量</span>
		<INPUT name="rtype" type=radio onclick=go_main(url+"5"); value="5" <?if ($lx=="5" ) {?>checked <?}?>><span>五肖量</span>
		</td>
    </tr>
        <tr>
            <td class="t_list_caption">生肖</td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">鼠</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">马</font></td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">牛</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">羊</font></td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">虎</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">猴</font></td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">兔</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">鸡</font></td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">龙</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">狗</font></td>
        ...
        <tr>
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">蛇</font></td>
            ...
            <td align="center" bgcolor="#FFFFFF"><font class="font_bold">猪</font></td>
        ...
        <tr>
            <td height="30" align="center" bgcolor="#FFFFFF" colspan="8" id="bnumber2">请输入下注金额
