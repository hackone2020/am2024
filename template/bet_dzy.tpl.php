<table  width="800" border="0" cellpadding="0" cellspacing="0">
   ...
   <table  width="800" border="0" cellpadding="0" cellspacing="1" class="t_list">
    <form target="leftFrame" name="form1" method="post"action="main.php?action=bet_n8&uid=<?=$uid?>&ids=<?=$ids?>&class2=<?=$class2?>" onSubmit="return ChkSubmit()">
        <tbody>
        <tr>
        <td height="27" colspan="15" align="center" class="t_list_tr_2">
            <INPUT name="rtype" type=radio onclick=go_main(url+"1"); value="1" <? if ($lx=="1" ) { echo "checked" ; }?> ><SPAN>四中一</SPAN>     
         <INPUT name="rtype" type=radio onclick=go_main(url+"2"); value="2" <? if ($lx == "2") { echo "checked" ; }?>><span>五中一</span>
         <INPUT name="rtype" type=radio onclick=go_main(url+"3"); value="3" <? if ($lx == "3") { echo "checked" ; }?>><span>六中一</span>
         <INPUT name="rtype" type=radio onclick=go_main(url+"4"); value="4" <? if ($lx == "4") { echo "checked" ; }?>><span>七中一</span>
         <INPUT name="rtype" type=radio onclick=go_main(url+"5"); value="5" <? if ($lx == "5") { echo "checked" ; }?>><span>八中一</span>
         <INPUT name="rtype" type=radio onclick=go_main(url+"6"); value="6" <? if ($lx == "6") { echo "checked" ; }?>><span>九中一</span>
         <INPUT name="rtype" type=radio onclick=go_main(url+"7"); value="7" <? if ($lx == "7") { echo "checked" ; }?>><span>十中一</span>
         </td>
         </tr>
        <TR>
        <td width="50" class="t_list_caption">号码</td>
        <td width="82" class="t_list_caption">勾选</td>
        <td width="50" class="t_list_caption">赔率</td>
        <td width="50" class="t_list_caption">号码</td>
        <td width="82" class="t_list_caption">勾选</td>
        <td width="50" class="t_list_caption">赔率</td>
        <td width="50" class="t_list_caption">号码</td>
    ...
    <tr>
        ...
        <td colspan="4" id="bnumber12" bgcolor="#FFFFFF"></td>
    </tr>
    <tr>
        <td colspan="15" id="bnumber"  height="30" align="center" bgcolor="#FFFFFF" >请输入每组下注金额:&nbsp;
